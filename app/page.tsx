...
export default function HomePage() {
  return <><SiteHeader /><main>
    ...
    <section className="section tint"><div className="shell"><div className="section-head"><div><span className="kicker">AI × CROSS-BORDER E-COMMERCE</span><h2>从“会用 AI”到“能带来业务结果”</h2><p>从选品、供应商和商品内容，到投放、履约、回款与风险合规，逐步跑通真实业务链路。</p></div><Link className="arrow-link" href="/tutorials?category=跨境电商">进入专题 →</Link></div><div className="card-grid three">{ecommerce.slice(0, 3).map((tutorial) => <TutorialCard key={tutorial.slug} tutorial={tutorial} slug={tutorial.slug} />)}</div></div></section>
